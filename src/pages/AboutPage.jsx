        ...
        <div className="min-h-screen bg-slate-950">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        {[
                            ...
                            <div key={idx} className="flex items-start gap-3 p-3 bg-slate-800/30 rounded-xl hover:bg-slate-800/50 transition">
            ...
            <div className="bg-gradient-to-r from-emerald-900/20 to-primary-900/20 py-16 border-y border-emerald-500/20">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <svg className="w-12 h-12 text-emerald-400 mx-auto mb-4 opacity-50" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                        <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-5a5 5 0 00-4.546 2.916A5 5 0 0010 15a5 5 0 004.546-2.916A5 5 0 0010 5z" clipRule="evenodd" />
                    </svg>
