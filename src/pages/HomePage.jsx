...
export default function HomePage() {
  const features = [
    ...
    { icon: Users, title: 'Global Workforce', description: 'Connect with professionals and employers worldwide' },
    { icon: Globe, title: '7 Countries & Growing', description: 'Jobs and talent from UK, Nigeria, Ireland, Canada, US, Germany, Australia' },
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="py-12 px-6 bg-gradient-to-r from-slate-900 to-slate-950 border-y border-slate-800">
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            >
              Not just another HR platform — an intelligent governance system for the modern workforce
            </motion.p>
          </div>
