...
//    src/lib/supabase.js). This would either fail to build entirely, or if
//    a stray config/supabase.js happens to exist, create yet another
//    disconnected-client instance. Fixed to the correct path.
...
//    conventions used everywhere else (including a responsive grid).
// 3. Read job.external_url, but ExternalJobsManager.jsx (the admin approval
//    tool for this same table) reads job.external_apply_url — two
//    different field names for what's presumably the same data. The real
//    column name isn't confirmed from this file alone, so this now checks
//    both rather than guessing which one is correct.
