      ...
      <div className="p-6 md:p-8">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          <div className="flex-1">
            ...
            <p className="text-slate-400 text-sm md:text-base max-w-md">{promo.description}</p>
          </div>
          ...
          <Link to={promo.cta.link} className="group px-6 py-3 bg-primary-600 text-white font-semibold rounded-xl hover:bg-primary-500 transition-all duration-200 flex items-center gap-2 shadow-lg shadow-primary-500/20 flex-shrink-0">
            {promo.cta.text}
