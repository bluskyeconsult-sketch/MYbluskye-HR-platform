          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1 px-3 py-2 rounded-lg text-sm font-medium text-slate-300 hover:text-white hover:bg-slate-800 transition-colors"
              >
                Resources
            ...
            <div className="flex flex-col space-y-2">
              ...
              {resourcesLinks.map((link) => (
                <Link
                  ...
                  to={link.path}
                  onClick={() => setMobileMenuOpen(false)}
                  className="pl-8 px-3 py-2 rounded-lg text-sm text-slate-400 hover:text-white hover:bg-slate-800"
                >
                  {link.name}
                </Link>
              ))}
